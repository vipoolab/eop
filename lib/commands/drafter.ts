...

{
  ...
  "letter": {
    ...
    "objective": "ความนำ ๑-๒ ย่อหน้า บอกที่มา/เหตุผล/บริบท ขึ้นต้นด้วย 'ด้วย...' หรือ 'ตามที่...' หรือ 'โดยที่...' ลงท้ายด้วย 'เพื่อให้...' หรือ 'เพื่อแก้ไขปัญหา...'",
    "legalBasis": "อาศัยอำนาจตามความในมาตรา ... แห่งพระราชบัญญัติ... <ตำแหน่งผู้สั่ง> จึงสั่งให้ดำเนินการดังต่อไปนี้",
    ...
    "reportInstruction": "(deprecated — ใส่ในข้อสั่งการสุดท้ายแทน) แต่ถ้าต้องการเก็บแยกก็ใส่ได้ เช่น 'รายงานผลทุกสัปดาห์ผ่านระบบ EOP'",
